    ...
    <div className="w-full lg:flex bg-[#1A1A1C] text-white">
      <div className="w-full lg:w-7/12 bg-overlay lg:pl-16 pt-20 px-8">
        ...
        <div className="flex flex-col-reverse lg:flex-row lg:pr-16">
          <div className="w-full lg:w-1/2 lg:pr-8 lg:pt-8 pb-8 ">
            <img src="./cohort.png" className="rounded-xl" />
          </div>
          <Card
            align={'right'}
        ...
        <div className="flex pt-6 pb-12 items-end">
        <img src="./Vector.svg" className="w-12 h-12" />
        {/* carousel */}
      ...
      <div className="w-full lg:w-5/12 bg-white flex justify-center items-center min-h-screen">
        <div className="w-10/12 lg:w-7/12">
          ...
          <p className="text-4xl font-medium text-gray-300 leading-10 pb-6">Sign up for exclusive access.</p>
          <input type="email" placeholder="Your email address" className="rounded-md border border-gray-100 bg-white shadow-sm text-base placeholder-opacity-50 indent-6 placeholder-gray-500 w-full h-12 mb-4" />
          <button type="button" class="w-full text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm py-2.5 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Get started</button>
          </div>
          <span className="text-gray-900 text-base">You’ll receive an email with an invite link to join.</span>
        </div>
      </div>
    </div>
  );
